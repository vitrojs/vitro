...
const SYMBOL_AS_CHILD_PROPS = Symbol ( 'AsChildProps' );
/* EXPORT */
...
export {CONTEXTS_DATA, DIRECTIVES, SYMBOL_SUSPENSE, SYMBOL_SUSPENSE_COLLECTOR, SYMBOL_TEMPLATE_ACCESSOR, SYMBOLS_DIRECTIVES, SYMBOL_AS_CHILD_PROPS};
